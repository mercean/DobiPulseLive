                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 text-center mb-6">
                    ...
                    <div class="grid md:grid-cols-2 gap-6 text-left mt-6">
                        <div class="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg">
                            ...
                            <p><strong>Total Paid:</strong> RM {{ number_format($payment->amount, 2) }}</p>
                            @if($discount > 0)
                                <p><strong>Discount:</strong> -RM {{ number_format($discount, 2) }} ({{ $couponCode }})</p>
                            @endif
                        ...
                        <div class="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg">
                            ...
                            <p><strong>Location:</strong> {{ $order->machine->location ?? '-' }}</p>
