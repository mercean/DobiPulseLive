...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="text-center text-sm text-gray-600 dark:text-gray-300">
                ...
                <a href="<?php echo e(route('register')); ?>" class="text-blue-600 hover:underline font-semibold">Register here</a>
            </div>
        </form>
    </div>
</div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\amirs\OneDrive\Documents\DobiPulseV3\resources\views\auth\login.blade.php ENDPATH**/ ?>