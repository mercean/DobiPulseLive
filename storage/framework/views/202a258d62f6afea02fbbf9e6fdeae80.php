...
<?php endif; ?>
        ...
        <!-- Promotion Form -->
        <form method="POST" action="<?php echo e(route('promotions.store')); ?>" enctype="multipart/form-data" class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md space-y-6">
            <?php echo csrf_field(); ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-5 h-5 absolute top-2.5 left-3 text-gray-400']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php endif; ?>
                        <input type="text" id="title" name="title" placeholder="Title" required
                            value="<?php echo e(old('title', $promotion->title ?? '')); ?>"
                ...
                <div>
                    ...
                    <textarea id="description" name="description" placeholder="Description"
                        class="input w-full rounded-lg border dark:border-gray-700 bg-gray-50 dark:bg-gray-800 focus:ring-blue-500 focus:outline-none text-sm text-gray-900 dark:text-white"><?php echo e(old('description', $promotion->description ?? '')); ?></textarea>
                </div>
                ...
                <div>
                    ...
                    <input type="number" id="value" name="value" step="0.01" required
                        value="<?php echo e(old('value', $promotion->value ?? '')); ?>"
                        class="input w-full rounded-lg border dark:border-gray-700 bg-gray-50 dark:bg-gray-800 focus:ring-blue-500 focus:outline-none text-sm text-gray-900 dark:text-white" />
                </div>
                ...
                <div class="grid sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="date" id="start_date" name="start_date" required
                            value="<?php echo e(old('start_date', isset($promotion) ? $promotion->start_date->toDateString() : '')); ?>"
                            class="input w-full rounded-lg border dark:border-gray-700 bg-gray-50 dark:bg-gray-800 focus:ring-blue-500 focus:outline-none text-sm text-gray-900 dark:text-white" />
                    </div>
                    <div>
                        <label for="end_date" class="block text-sm font-medium mb-1">End Date</label>
                        <input type="date" id="end_date" name="end_date" required
                            value="<?php echo e(old('end_date', isset($promotion) ? $promotion->end_date->toDateString() : '')); ?>"
                            class="input w-full rounded-lg border dark:border-gray-700 bg-gray-50 dark:bg-gray-800 focus:ring-blue-500 focus:outline-none text-sm text-gray-900 dark:text-white" />
                    </div>
                </div>
                ...
                <div class="flex items-center gap-2">
                    <input type="checkbox" id="auto_apply" name="auto_apply" value="1"
                        <?php echo e(old('auto_apply', $promotion->auto_apply ?? false) ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\amirs\OneDrive\Documents\DobiPulseV3\resources\views/admin/promotions/create.blade.php ENDPATH**/ ?>