...
<?php endif; ?>
                <div>
                    ...
                    <p class="text-xl font-semibold"><?php echo e($orders->count()); ?></p>
                </div>
            </div>
            <div class="bg-white dark:bg-gray-800 p-4 rounded-xl shadow flex items-center gap-4">
                <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
...
<?php endif; ?>
                <div>
                    ...
                    <p class="text-xl font-semibold"><?php echo e($orders->where('status', 'approved')->count()); ?></p>
                </div>
            </div>
            <div class="bg-white dark:bg-gray-800 p-4 rounded-xl shadow flex items-center gap-4">
                <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
...
<?php endif; ?>
                <div>
                    ...
                    <p class="text-xl font-semibold"><?php echo e($orders->where('status', 'pending')->count()); ?></p>
                </div>
            </div>
            <div class="bg-white dark:bg-gray-800 p-4 rounded-xl shadow flex items-center gap-4">
                <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
...
<?php endif; ?>
                <div>
                    ...
                    <p class="text-xl font-semibold">RM<?php echo e(number_format($orders->sum('total_amount'), 2)); ?></p>
                </div>
            </div>
        </div>
                                ...
                                <tr>
                                    ...
                                    <td class="px-4 py-2 flex flex-wrap gap-2">
                                        <?php if($order->status === 'pending'): ?>
                                            <form method="POST" action="<?php echo e(route('orders.destroy', $order->id)); ?>" onsubmit="return confirm('Cancel this order?');">
                                                <?php echo csrf_field(); ?>
...
<?php endif; ?> Cancel
                                            ...
                                            <a href="<?php echo e(route('payment.regular.page', $order->id)); ?>" class="inline-flex items-center gap-1 bg-blue-600 hover:bg-blue-700 text-white px-3 py-1 rounded">
                                                <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\amirs\OneDrive\Documents\DobiPulseV3\resources\views/regular/orders/index.blade.php ENDPATH**/ ?>