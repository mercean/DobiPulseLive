...
<?php endif; ?>
                <div>
                    ...
                    <div class="text-2xl font-bold text-purple-600 dark:text-purple-400"><?php echo e($totalBulkOrders); ?></div>
                </div>
            </div>
            <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow flex items-center gap-4">
                <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-6 h-6 text-yellow-500']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php endif; ?>
                <div>
                    ...
                    <div class="text-2xl font-bold text-yellow-500 dark:text-yellow-400"><?php echo e($pendingBulkOrders); ?></div>
                </div>
            </div>
            <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow flex items-center gap-4">
                <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
...
<?php endif; ?>
                <div>
                    ...
                    <div class="text-2xl font-bold text-indigo-600 dark:text-indigo-400"><?php echo e(number_format($totalBulkWeight, 1)); ?> kg</div>
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4">
            <a href="<?php echo e(route('bulk.orders.create')); ?>"
...
<?php $component = $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?> New Bulk Order
            </a>

            <!-- Filter -->
            <form method="GET" action="<?php echo e(route('bulk.orders.index')); ?>" class="flex items-center gap-2">
                ...
                <select name="status" id="status"
                    ...
                    <option value="PayNow" <?php echo e(request('status') === 'PayNow' ? 'selected' : ''); ?>>PayNow</option>
                ...
                <table class="min-w-full text-sm text-left text-gray-600 dark:text-gray-300">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                            ...
                            <td class="px-6 py-4"><?php echo e(ucfirst($order->status)); ?></td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4 space-x-2">
                                <a href="<?php echo e(route('bulk.orders.edit', $order->id)); ?>"
...
<?php endif; ?> Edit
                                ...
                                <form action="<?php echo e(route('bulk.orders.destroy', $order->id)); ?>" method="POST" class="inline">
                                    <?php echo csrf_field(); ?>
...
<?php endif; ?> Delete
                                ...
                                <?php if($order->status === 'PayNow' && $order->price > 0): ?>
                                    <a href="<?php echo e(route('payment.bulk.gateway', $order->id)); ?>"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\amirs\OneDrive\Documents\DobiPulseV3\resources\views\bulk_orders\index.blade.php ENDPATH**/ ?>