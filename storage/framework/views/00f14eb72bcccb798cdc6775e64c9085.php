<aside :class="showSidebar ? 'translate-x-0' : '-translate-x-full'"
    ...
    <div class="flex items-center justify-between p-4 border-b dark:border-gray-700">
        <div class="flex items-center space-x-3">
            <?php $user = Auth::user(); ?>
            <img src="<?php echo e($user && $user->avatar ? asset('storage/' . $user->avatar) : 'https://ui-avatars.com/api/?name=' . urlencode($user->name ?? 'Guest') . '&background=0D8ABC&color=fff&size=80'); ?>" 
            ...
            <div>
                ...
                <div class="flex items-center gap-1">
                    <p class="text-xs text-gray-500 dark:text-gray-400">
                        <?php echo e($user ? 'Regular User' : 'Visitor'); ?>
...
<?php endif; ?> Dashboard
        ...
        <?php if($user): ?>
        <a href="<?php echo e(route('regular.orders')); ?>" class="flex items-center gap-2 px-4 py-2 rounded hover:bg-blue-500 hover:text-white dark:hover:bg-blue-600">
            <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php /**PATH C:\Users\amirs\OneDrive\Documents\DobiPulseV3\resources\views\components\regular\sidebar.blade.php ENDPATH**/ ?>