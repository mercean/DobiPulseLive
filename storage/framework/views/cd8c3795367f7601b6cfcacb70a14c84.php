                ...
                <table class="w-full table-auto text-sm text-left rounded overflow-hidden">
                    ...
                    <tbody class="divide-y dark:divide-gray-600 text-gray-700 dark:text-gray-300" id="machine_table_body">
                        <?php $__currentLoopData = $machines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $machine): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            ?>
                            <tr class="machine-row" data-type="<?php echo e(strtolower($machine->type)); ?>">
                                <td class="px-4 py-2"><?php echo e($machine->id); ?></td>
                                <td><?php echo e(ucfirst($machine->type)); ?> <span class="text-xs text-gray-400">(<?php echo e($machine->type === 'dryer' ? 'RM4/30min' : 'RM5/30min'); ?>)</span></td>
                                <td><?php echo e($machine->location ?? '-'); ?></td>
                                <td>
                                    <?php if($isCountdown): ?>
                                        <span class="countdown text-yellow-500" data-end-time="<?php echo e($active->end_time->toIso8601String()); ?>">Calculating...</span>
                                    <?php elseif($isPendingBuyer): ?>
                                ...
                                <td>
                                    <?php if(
                                        ...
                                        <input type="checkbox" name="machine_ids[]" value="<?php echo e($machine->id); ?>" class="machine-checkbox" data-type="<?php echo e(strtolower($machine->type)); ?>">
                                    <?php else: ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\amirs\OneDrive\Documents\DobiPulseV3\resources\views/dashboard/new_order.blade.php ENDPATH**/ ?>