<aside :class="showSidebar ? 'translate-x-0' : '-translate-x-full'"
    ...
    <div class="flex items-center justify-between p-4 border-b dark:border-gray-700">
        <div class="flex items-center space-x-3">
            ...
            <div>
                <p class="text-sm font-semibold text-gray-800 dark:text-white truncate"><?php echo e(Auth::user()->name); ?></p>
                <div class="flex items-center gap-1">
                    <p class="text-xs text-gray-500 dark:text-gray-400">Bulk User</p>
                    <a href="<?php echo e(route('edit.profile')); ?>" title="Edit Profile" class="text-gray-400 hover:text-blue-500">
...
<?php endif; ?> Dashboard
        ...
        <a href="<?php echo e(route('bulk.orders.index')); ?>" class="flex items-center gap-2 px-4 py-2 rounded hover:bg-blue-500 hover:text-white dark:hover:bg-blue-600">
            <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?> My Orders
        ...
        <a href="<?php echo e(route('bulk.orders.create')); ?>" class="flex items-center gap-2 px-4 py-2 rounded hover:bg-blue-500 hover:text-white dark:hover:bg-blue-600">
            <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?> Create Order
        ...
        <a href="<?php echo e(route('edit.profile')); ?>" class="flex items-center gap-2 px-4 py-2 rounded hover:bg-blue-500 hover:text-white dark:hover:bg-blue-600">
            <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?> Edit Profile
        </a>
    </nav>
</aside>
<?php /**PATH C:\Users\amirs\OneDrive\Documents\DobiPulseV3\resources\views\components\bulk\sidebar.blade.php ENDPATH**/ ?>