...
<?php $component->withName('heroicon-o-receipt-refund'); ?>
...
<?php endif; ?>
    ...
    <div class="mb-4 border-t border-b py-4 space-y-2 text-sm">
        ...
        <div class="flex justify-between">
            ...
            <span><?php echo e($userPoints); ?> pts</span>
        </div>
    </div>
...
<?php endif; ?>
        ...
        <div class="bg-gray-100 dark:bg-gray-700 rounded-lg p-4">
            <p class="text-gray-700 dark:text-gray-200">
                <strong>Machine #<?php echo e($order->machine->id); ?></strong> – <?php echo e(ucfirst($order->machine->type)); ?> at <?php echo e($order->machine->location); ?>
...
<div class="mt-6 flex justify-center gap-4 print:hidden">
    <a href="<?php echo e(route('regular.orders')); ?>" class="flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">
        <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
    ...
    <a href="<?php echo e(route('receipt.download', $order->id)); ?>" class="flex items-center gap-2 px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700">
        <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\amirs\OneDrive\Documents\DobiPulseV3\resources\views/orders/show.blade.php ENDPATH**/ ?>